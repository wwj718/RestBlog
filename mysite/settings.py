...
import os
settings_dir = os.path.dirname(__file__)  #settings.py所在目录
PROJECT_ROOT = os.path.abspath(os.path.dirname(settings_dir))  #项目根目录
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'public/static/') #物理路径 用于机器存储，对外的是STATIC_URL
